...
public class AlwaysTopServiceTouch extends Service {
    ...
    private View.OnClickListener mButtonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(view.getId() == R.id.btnStart){
                Toast.makeText(AlwaysTopServiceTouch.this, "Button Click", Toast.LENGTH_SHORT).show();

                //mService.myServiceFunc();

            }else{
                Toast.makeText(AlwaysTopServiceTouch.this, "Overlay mBStart click event", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    public void onCreate() {
        ...
        mButton = mView.findViewById(R.id.btnStart);
