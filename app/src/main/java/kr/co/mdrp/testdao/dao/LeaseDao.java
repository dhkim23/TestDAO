...
public class LeaseDao extends AbstractDao<Lease, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Lease entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Lease entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(Lease entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Lease entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Lease entity) {
